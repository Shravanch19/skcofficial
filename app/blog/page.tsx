...
const page = () => {
    ...
    const blogData: Record<BlogKeys, { title: string; description: string; image: string; content: string }> = {
      dharavahik: {
        ...
        content: `
          Dharavahik is an innovative streaming platform built using Next.js. 
          It enables users to search for and stream movies/web series seamlessly. 
          With AI-driven features, users can find content even if it's not in the database.
        `,
      },
      "model-forge": {
        ...
        content: `
          Model Forge is an AI-based tool designed to automate the generation of machine learning models.
          Built with Flask, it allows users to define their dataset and get a model with minimal effort.
        `,
      },
      myjarvis: {
        ...
        content: `
          MyJarvis is an AI-powered virtual assistant that can handle tasks like automation, reminders, and even basic coding help.
          It integrates with various APIs to provide seamless assistance.
        `,
      },
    };
